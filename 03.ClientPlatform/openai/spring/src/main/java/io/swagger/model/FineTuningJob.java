...
import io.swagger.model.FineTuningJobError;
import io.swagger.model.FineTuningJobHyperparameters;
...
public class FineTuningJob   {
  ...
  @Size(max=5)   public List<OneOfFineTuningJobIntegrationsItems> getIntegrations() {
    return integrations;
  }
