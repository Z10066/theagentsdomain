...
public class CreateImageRequest   {
  ...
  @JsonProperty("model")
  private AnyOfCreateImageRequestModel model = dall-e-2;
  ...
  public CreateImageRequest model(AnyOfCreateImageRequestModel model) {
    this.model = model;
    return this;
  }
  ...
  @Schema(example = "dall-e-3", description = "The model to use for image generation.")
    ...
    public AnyOfCreateImageRequestModel getModel() {
    return model;
  }

  public void setModel(AnyOfCreateImageRequestModel model) {
    this.model = model;
  }
