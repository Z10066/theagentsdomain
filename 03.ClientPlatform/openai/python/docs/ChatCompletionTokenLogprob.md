...
**top_logprobs** | [**list[ChatCompletionTokenLogprobTopLogprobs]**](ChatCompletionTokenLogprobTopLogprobs.md) | List of the most likely tokens and their log probability, at this token position. In rare cases, there may be fewer than the number of requested &#x60;top_logprobs&#x60; returned. | 
