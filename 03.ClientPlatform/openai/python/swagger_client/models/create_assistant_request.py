...
class CreateAssistantRequest(object):
    ...
    """
    swagger_types = {
        'model': 'AnyOfCreateAssistantRequestModel',
        'name': 'str',
        'description': 'str',
        'instructions': 'str',
        'tools': 'list[OneOfCreateAssistantRequestToolsItems]',
    ...
    def __init__(self, model=None, name=None, description=None, instructions=None, tools=None, tool_resources=None, metadata=None, temperature=1, top_p=1, response_format=None):  # noqa: E501
        """CreateAssistantRequest - a model defined in Swagger"""  # noqa: E501
        self._model = None
        self._name = None
    ...
    @property
    def model(self):
        """Gets the model of this CreateAssistantRequest.  # noqa: E501
        ...
        :return: The model of this CreateAssistantRequest.  # noqa: E501
        :rtype: AnyOfCreateAssistantRequestModel
        """
        return self._model
    ...
    def model(self, model):
        ...
        :type: AnyOfCreateAssistantRequestModel
        """
        if model is None:
    ...
    @property
    def name(self):
        """Gets the name of this CreateAssistantRequest.  # noqa: E501

        The name of the assistant. The maximum length is 256 characters.   # noqa: E501

        :return: The name of this CreateAssistantRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def description(self):
        """Gets the description of this CreateAssistantRequest.  # noqa: E501

        The description of the assistant. The maximum length is 512 characters.   # noqa: E501

        :return: The description of this CreateAssistantRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def instructions(self):
        """Gets the instructions of this CreateAssistantRequest.  # noqa: E501

        The system instructions that the assistant uses. The maximum length is 256,000 characters.   # noqa: E501

        :return: The instructions of this CreateAssistantRequest.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def tools(self):
        """Gets the tools of this CreateAssistantRequest.  # noqa: E501
        ...
        :return: The tools of this CreateAssistantRequest.  # noqa: E501
        :rtype: list[OneOfCreateAssistantRequestToolsItems]
        """
        return self._tools
    ...
    def tools(self, tools):
        ...
        :type: list[OneOfCreateAssistantRequestToolsItems]
        """
    ...
    def tool_resources(self):
        """Gets the tool_resources of this CreateAssistantRequest.  # noqa: E501


        :return: The tool_resources of this CreateAssistantRequest.  # noqa: E501
    ...
    @property
    def metadata(self):
        """Gets the metadata of this CreateAssistantRequest.  # noqa: E501
        ...
        :return: The metadata of this CreateAssistantRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def temperature(self):
        """Gets the temperature of this CreateAssistantRequest.  # noqa: E501
        ...
        :return: The temperature of this CreateAssistantRequest.  # noqa: E501
        :rtype: float
        """
    ...
    @property
    def top_p(self):
        """Gets the top_p of this CreateAssistantRequest.  # noqa: E501

        An alternative to sampling with temperature, called nucleus sampling, where the model considers the results of the tokens with top_p probability mass. So 0.1 means only the tokens comprising the top 10% probability mass are considered.  We generally recommend altering this or temperature but not both.   # noqa: E501

        :return: The top_p of this CreateAssistantRequest.  # noqa: E501
        :rtype: float
        """
        return self._top_p
    ...
    def response_format(self):
        """Gets the response_format of this CreateAssistantRequest.  # noqa: E501


        :return: The response_format of this CreateAssistantRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateAssistantRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAssistantRequest):
            return False
