...
class ChatCompletionNamedToolChoice(object):
    ...
    def __init__(self, type=None, function=None):  # noqa: E501
        """ChatCompletionNamedToolChoice - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._function = None
    ...
    @property
    def type(self):
        """Gets the type of this ChatCompletionNamedToolChoice.  # noqa: E501

        The type of the tool. Currently, only `function` is supported.  # noqa: E501

        :return: The type of this ChatCompletionNamedToolChoice.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @property
    def function(self):
        """Gets the function of this ChatCompletionNamedToolChoice.  # noqa: E501


        :return: The function of this ChatCompletionNamedToolChoice.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChatCompletionNamedToolChoice, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatCompletionNamedToolChoice):
            return False
