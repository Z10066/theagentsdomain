...
class MessageDeltaContentImageUrlObjectImageUrl(object):
    ...
    def __init__(self, url=None, detail='auto'):  # noqa: E501
        """MessageDeltaContentImageUrlObjectImageUrl - a model defined in Swagger"""  # noqa: E501
        self._url = None
        self._detail = None
    ...
    @property
    def url(self):
        """Gets the url of this MessageDeltaContentImageUrlObjectImageUrl.  # noqa: E501

        The URL of the image, must be a supported image types: jpeg, jpg, png, gif, webp.  # noqa: E501

        :return: The url of this MessageDeltaContentImageUrlObjectImageUrl.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @property
    def detail(self):
        """Gets the detail of this MessageDeltaContentImageUrlObjectImageUrl.  # noqa: E501

        Specifies the detail level of the image. `low` uses fewer tokens, you can opt in to high resolution using `high`.  # noqa: E501

        :return: The detail of this MessageDeltaContentImageUrlObjectImageUrl.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MessageDeltaContentImageUrlObjectImageUrl, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageDeltaContentImageUrlObjectImageUrl):
            return False
