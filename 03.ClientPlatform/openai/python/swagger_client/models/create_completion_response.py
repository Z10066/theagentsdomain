...
class CreateCompletionResponse(object):
    ...
    def __init__(self, id=None, choices=None, created=None, model=None, system_fingerprint=None, object=None, usage=None):  # noqa: E501
        """CreateCompletionResponse - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._choices = None
        self._created = None
        self._model = None
    ...
    @property
    def id(self):
        """Gets the id of this CreateCompletionResponse.  # noqa: E501

        A unique identifier for the completion.  # noqa: E501

        :return: The id of this CreateCompletionResponse.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @property
    def choices(self):
        """Gets the choices of this CreateCompletionResponse.  # noqa: E501

        The list of completion choices the model generated for the input prompt.  # noqa: E501

        :return: The choices of this CreateCompletionResponse.  # noqa: E501
        :rtype: list[CreateCompletionResponseChoices]
        """
    ...
    def choices(self, choices):
        ...
        :type: list[CreateCompletionResponseChoices]
        """
        if choices is None:
    ...
    @property
    def created(self):
        """Gets the created of this CreateCompletionResponse.  # noqa: E501

        The Unix timestamp (in seconds) of when the completion was created.  # noqa: E501

        :return: The created of this CreateCompletionResponse.  # noqa: E501
        :rtype: int
        """
    ...
    @property
    def model(self):
        """Gets the model of this CreateCompletionResponse.  # noqa: E501

        The model used for completion.  # noqa: E501

        :return: The model of this CreateCompletionResponse.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def system_fingerprint(self):
        """Gets the system_fingerprint of this CreateCompletionResponse.  # noqa: E501
        ...
        :return: The system_fingerprint of this CreateCompletionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def object(self):
        """Gets the object of this CreateCompletionResponse.  # noqa: E501

        The object type, which is always \"text_completion\"  # noqa: E501

        :return: The object of this CreateCompletionResponse.  # noqa: E501
        :rtype: str
        """
        return self._object
    ...
    @property
    def usage(self):
        """Gets the usage of this CreateCompletionResponse.  # noqa: E501


        :return: The usage of this CreateCompletionResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateCompletionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCompletionResponse):
            return False
