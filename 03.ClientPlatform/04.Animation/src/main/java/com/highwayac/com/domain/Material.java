...
public class Material implements Serializable {
    ...
    public Material creator(String creator) {
    ...
    public Material copyright(String copyright) {
    ...
    public Material watchLink(String watchLink) {
    ...
    public Material extraInfo(ExtraInfo extraInfo) {
    ...
    public Material workspace(Workspace workspace) {
