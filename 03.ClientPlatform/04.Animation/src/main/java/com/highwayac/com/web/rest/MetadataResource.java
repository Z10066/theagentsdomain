...
import com.highwayac.com.service.MetadataService;
...
/**
 * REST controller for managing {@link com.highwayac.com.domain.Metadata}.
 */
@RestController
...
public class MetadataResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<MetadataDTO>> createMetadata(@RequestBody MetadataDTO metadataDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/{id}")
    public Mono<ResponseEntity<MetadataDTO>> updateMetadata(
    ...
    public Mono<ResponseEntity<MetadataDTO>> partialUpdateMetadata(
        @PathVariable(value = "id", required = false) final Long id,
        @RequestBody MetadataDTO metadataDTO
    ) throws URISyntaxException {
        ...
        return metadataRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<MetadataDTO> result = metadataService.partialUpdate(metadataDTO);
    ...
    public Mono<ResponseEntity<List<MetadataDTO>>> getAllMetadata(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        ServerHttpRequest request,
        @RequestParam(name = "filter", required = false) String filter
    ) {
        if ("video-is-null".equals(filter)) {
            log.debug("REST request to get all Metadatas where video is null");
            return metadataService.findAllWhereVideoIsNull().collectList().map(ResponseEntity::ok);
        }
        log.debug("REST request to get a page of Metadata");
        return metadataService
            .countAll()
            .zipWith(metadataService.findAll(pageable).collectList())
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<MetadataDTO>> getMetadata(@PathVariable("id") Long id) {
        log.debug("REST request to get Metadata : {}", id);
        Mono<MetadataDTO> metadataDTO = metadataService.findOne(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteMetadata(@PathVariable("id") Long id) {
