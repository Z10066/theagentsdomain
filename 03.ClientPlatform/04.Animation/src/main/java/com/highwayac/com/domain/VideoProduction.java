...
public class VideoProduction implements Serializable {
    ...
    public VideoProduction id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public VideoProduction title(String title) {
        this.setTitle(title);
        return this;
    }
    ...
    public VideoProduction creator(String creator) {
    ...
    public VideoProduction description(String description) {
    ...
    public VideoProduction copyright(String copyright) {
    ...
    public VideoProduction watchLink(String watchLink) {
    ...
    public VideoProduction extraInfo(ExtraInfo extraInfo) {
    ...
    public VideoProduction workspace(Workspace workspace) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VideoProduction)) {
            return false;
        }
        return getId() != null && getId().equals(((VideoProduction) o).getId());
    }
