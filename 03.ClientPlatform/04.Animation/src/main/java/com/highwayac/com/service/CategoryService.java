...
import com.highwayac.com.repository.CategoryRepository;
import com.highwayac.com.service.dto.CategoryDTO;
import com.highwayac.com.service.mapper.CategoryMapper;
...
/**
 * Service Implementation for managing {@link com.highwayac.com.domain.Category}.
 */
@Service
@Transactional
public class CategoryService {
    ...
    /**
     *  Get all the categories where Video is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public Flux<CategoryDTO> findAllWhereVideoIsNull() {
        log.debug("Request to get all categories where Video is null");
        return categoryRepository.findAllWhereVideoIsNull().map(categoryMapper::toDto);
    }
