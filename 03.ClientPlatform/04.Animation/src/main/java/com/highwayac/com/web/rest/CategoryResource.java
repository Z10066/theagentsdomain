...
import com.highwayac.com.service.CategoryService;
...
/**
 * REST controller for managing {@link com.highwayac.com.domain.Category}.
 */
@RestController
...
public class CategoryResource {
    ...
    public Mono<ResponseEntity<List<CategoryDTO>>> getAllCategories(
        ...
        if ("video-is-null".equals(filter)) {
            log.debug("REST request to get all Categorys where video is null");
            return categoryService.findAllWhereVideoIsNull().collectList().map(ResponseEntity::ok);
        }
