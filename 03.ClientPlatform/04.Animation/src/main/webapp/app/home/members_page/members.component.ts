...
import { EntityArrayResponseType, MemberService } from 'app/entities/member/service/member.service';
...
export class MembersComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.members = this.refineData(dataFromBody);
  }

  protected refineData(data: IMember[]): IMember[] {
