...
export const systemSettingResolve = (route: ActivatedRouteSnapshot): Observable<null | ISystemSetting> => {
  const id = route.params['id'];
  if (id) {
    return inject(SystemSettingService)
      .find(id)
      .pipe(
...
export default systemSettingResolve;
