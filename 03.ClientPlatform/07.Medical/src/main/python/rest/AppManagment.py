...
class AppManagementConfigurationResource(Resource):
    ...
    def get(self):
        ...
        flask_config_variables["contexts"]["highwaymb"] = {}
        flask_config_variables["contexts"]["highwaymb"]["beans"] = {}
        for var in config_vars:
            config_dict = {"prefix": var, "properties": {var: str(flask_config[var])}}
            flask_config_variables["contexts"]["highwaymb"]["beans"][var] = config_dict
...
class AppManagementOpenAPIResource(Resource):
    ...
    def get(self):
        return [ {
            "description" : "HighwaymbApp Application (default)",
            "group" : "default"
            }
        ], 200
