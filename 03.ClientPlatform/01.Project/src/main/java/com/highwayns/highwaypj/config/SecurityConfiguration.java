package com.highwayns.highwaypj.config;
...
import com.highwayns.highwaypj.security.AuthoritiesConstants;
import com.highwayns.highwaypj.security.SecurityUtils;
import com.highwayns.highwaypj.security.oauth2.AudienceValidator;
import com.highwayns.highwaypj.security.oauth2.JwtGrantedAuthorityConverter;
import com.highwayns.highwaypj.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        http
            ...
            .cors(withDefaults())
            .csrf(csrf ->
                csrf.requireCsrfProtectionMatcher(disabledUrlForCSRF())// 忽略 Webhook 端点的 CSRF
            ...
            .authorizeExchange(authz ->
                ...
                authz
                    ...
                    .pathMatchers("/api/stripe/webhook").permitAll() // 允许匿名访问 Webhook 端点
    ...
    private AndServerWebExchangeMatcher disabledUrlForCSRF() {
        return new AndServerWebExchangeMatcher(
            CsrfWebFilter.DEFAULT_CSRF_MATCHER,
            new NegatedServerWebExchangeMatcher(
                pathMatchers("/api/stripe/webhook")
            )
        );
    }
