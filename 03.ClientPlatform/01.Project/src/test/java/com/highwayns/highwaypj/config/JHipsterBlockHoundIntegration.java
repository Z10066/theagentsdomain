...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.highwayns.highwaypj.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.highwayns.highwaypj.security.DomainUserDetailsService", "createSpringSecurityUser");
