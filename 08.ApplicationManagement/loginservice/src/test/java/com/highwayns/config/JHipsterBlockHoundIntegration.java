...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.highwayns.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.highwayns.security.DomainUserDetailsService", "createSpringSecurityUser");
